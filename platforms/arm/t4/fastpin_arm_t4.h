...
// 1062 default is fast GPIO  GPIO1-4 to GPIO6-9

_IO32(6); _IO32(7); _IO32(8); _IO32(9);

#define MAX_PIN 34
_DEFPIN_ARM( 0,  3, 6); _DEFPIN_ARM( 1,  2, 6); _DEFPIN_ARM( 2,  4, 9); _DEFPIN_ARM( 3,  5, 9);
_DEFPIN_ARM( 4,  6, 9); _DEFPIN_ARM( 5,  8, 9); _DEFPIN_ARM( 6, 10,  7); _DEFPIN_ARM( 7, 17, 7);
_DEFPIN_ARM( 8, 16, 7); _DEFPIN_ARM( 9, 11, 7); _DEFPIN_ARM(10,  0, 7); _DEFPIN_ARM(11,  2, 7);
_DEFPIN_ARM(12,  1, 7); _DEFPIN_ARM(13,  3, 7); _DEFPIN_ARM(14, 18, 6); _DEFPIN_ARM(15, 19, 6);
_DEFPIN_ARM(16, 23, 6); _DEFPIN_ARM(17, 22, 6); _DEFPIN_ARM(18, 17, 6); _DEFPIN_ARM(19, 16, 6);
_DEFPIN_ARM(20, 26, 6); _DEFPIN_ARM(21, 27, 6); _DEFPIN_ARM(22, 24, 6); _DEFPIN_ARM(23, 25, 6);
_DEFPIN_ARM(24, 12, 6); _DEFPIN_ARM(25, 13, 6); _DEFPIN_ARM(26, 30, 6); _DEFPIN_ARM(27, 31, 6);
_DEFPIN_ARM(28, 18, 8); _DEFPIN_ARM(29, 31, 9); _DEFPIN_ARM(30, 23, 8); _DEFPIN_ARM(31, 22, 8);
_DEFPIN_ARM(32, 12, 7); _DEFPIN_ARM(33, 7, 9);
